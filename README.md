...
更新以及安装防火墙放行端口
```
sudo DEBIAN_FRONTEND=noninteractive NEEDRESTART_MODE=a apt update -y && sudo apt install -y ufw && yes | sudo ufw enable && sudo ufw allow 22/tcp && sudo ufw allow 5000/tcp && sudo ufw allow 7000/tcp && sudo ufw status
```  
